class CreditCardsController < ApplicationController
  ...
  def index
    ...
    credit = user.credit_cards
    @credit_cards = credit.paginate(page: params[:page], per_page: 10)
  ...
  private
    ...
    def credit_card_params
      params.fetch(:credit_card).permit(:card_number, :expiration_date, :cvv, :user_id)
    end
end
